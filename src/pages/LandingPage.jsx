      ...
      <section className="relative bg-gradient-to-r from-[#1E3A8A] to-[#152C5E] text-white py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <AnimatePresence mode="wait">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-[#1E3A8A]/90 to-[#152C5E]/90"></div>
            </motion.div>
          </AnimatePresence>
        </div>
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123.06s3.057-.012 4.123-.06c1.064-.049 1.791-.218 2.427-.465a4.902 4.902 0 011.772-1.153 4.902 4.902 0 011.153-1.772c.247-.636.416-1.363.465-2.427.047-1.024.06-1.379.06-4.123 0-2.744-.013-3.099-.06-4.123-.049-1.064-.218-1.791-.465-2.427a4.902 4.902 0 00-1.153-1.772 4.902 4.902 0 00-1.772-1.153c-.636-.247-1.363-.416-2.427-.465C15.528 2.013 15.183 2 12.315 2zm0 2a10.066 10.066 0 00-1.44.098c-.866.123-1.42.27-1.73.46-.303.185-.56.495-.697.912-.15.433-.184.953-.204 1.855-.021.9-.032 1.12-.032 3.675s.011 2.774.032 3.675c.02.902.054 1.422.204 1.855.136.417.394.727.697.912.31.19.864.337 1.73.46.48.068.958.098 1.44.098.482 0 .96-.03 1.44-.098.866-.123 1.42-.27 1.73-.46.303-.185.56-.495.697-.912.15-.433.184-.953.204-1.855.021-.9.032-1.12.032-3.675 0-2.555-.011-2.774-.032-3.675-.02-.902-.054-1.422-.204-1.855a1.947 1.947 0 00-.697-.912c-.31-.19-.864-.337-1.73-.46A10.066 10.066 0 0012.315 4z" clipRule="evenodd" />
                      </svg>
                    )
                  },
                  {
